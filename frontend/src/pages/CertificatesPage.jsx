...
export const CERTIFICATE_TYPES = [
  ...
  { value: 'barangay_indigency', label: 'Barangay Certificate of Indigency' },
  { value: 'indigency_minor', label: 'Certificate of Indigency For Minor' },
  { value: 'indigency_legal_age', label: 'Certificate of Indigency For Legal Age' },
  { value: 'residency', label: 'Barangay Certificate of Residency' },
...
export const CERTIFICATE_SUBTITLES = [
  { value: 'ra_11261', label: '(First Time Jobseekers Assistance Act – RA 11261)' },
...
const CertificatesPage = () => {
  ...
  const normalizedCertType =
    certType === "indigency_minor" || certType === "indigency_legal_age"
      ? "indigency"
      : certType;

  const mainTitle = isCustom
    ? customCert
    : CERTIFICATE_TYPES.find(c => c.value === normalizedCertType)?.label || "";
  ...
  const captainSignatureUrl = captainOfficial?.signature_path
    ? `${API_ROOT}${captainOfficial.signature_path.startsWith("/") ? "" : "/"}${captainOfficial.signature_path}`
    : null;

  const secretarySignatureUrl = secretaryOfficial?.signature_path
    ? `${API_ROOT}${secretaryOfficial.signature_path.startsWith("/") ? "" : "/"}${secretaryOfficial.signature_path}`
    : null;
  ...
  const generatePdf = async () => {
    if (!previewRef.current) {
      alert("Certificate preview not ready");
      return;
    }
    ...
    await AuditMyAction("Exported a pdf file of a certificate/document in Certificate Page");
  };
  ...
  const generateDefaultCertificateBody = () => {
    ...
    <p style="text-align:justify;margin-bottom:16px;font-size:20px;text-indent:45px;">
      ...
      <b><u>${buildFullName(selectedResident)?.toUpperCase() || "FULL NAME"}</u></b>,
...
`}
      ...
      <Grid item xs={12} md={6}>
        ...
        <Card sx={{ p: 3, mb: 3, mt: -.5, border: "2px solid black", width: "99%" }} elevation={3}>
        ...
        <Card sx={{ p: 3, border: "2px solid black", width: "99%", mt: -.5 }} elevation={3}>
            ...
            >
              ...
              <Grid item>
                ...
                {myRole === "User" && (
                  <>
                    {checkingPermission ? (
                      <Button variant="contained" sx={{ ml: 2, height: "56px", width: "223px" }} disabled>
                        Checking permission...
                      </Button>
                    ) : !canPrint ? (
                      <Button variant="contained" sx={{ ml: 2, height: "56px", width: "223px" }} onClick={requestCertificate}>
                        Request Certificate
                      </Button>
                    ) : (
                      <Button variant="contained" sx={{ ml: 2, height: "56px", width: "223px", backgroundColor: "green", color: "white" }} onClick={handleGeneratePdfUser}>
                        Generate PDF
                      </Button>
                    )}
                  </>
              ...
              <Grid item>
                <Button
                  ...
                  onClick={() => {
                    if (myRole === "User" && !canPrint) {
                      showSnackbar("Certificate is not approved yet.", "error");
                      return;
                    }
        ...
        {!isBarangayCertificate && (
          ...
          >
            ...
            <Typography align="center" sx={{
              fontSize: "32px",
              fontFamily: "Bernard MT", fontWeight: "bold", mt: -2,
            }}>
            ...
            <Typography align="center" sx={{
              fontSize: "32px",
              fontFamily: "Bernard MT", fontWeight: "bold", letterSpacing: 3, color: "red", mt: -2,
            }}>
              {settings.address &&
            ...
            <Typography align="center" sx={{ fontSize: "18px", mt: -1, fontFamily: "Times New Roman" }}>
            ...
            >
              ...
              <Box sx={{ position: "relative", zIndex: 10, display: "flex" }}>
                ...
                >
                  <Typography
                    sx={{ textAlign: "center", fontWeight: "bold", color: "red", mb: 5, fontFamily: "Cooper Black", fontSize: "24px" }}
                  >
                  ...
                  <Typography
                    sx={{ fontWeight: "bold", color: "red", mb: 2, textAlign: "center", fontFamily: "Times new roman", fontSize: "16px" }}
                  >
                    PUNONG BARANGAY
                  </Typography>
                  ...
                  <Typography sx={{ fontWeight: "bold", color: "red", mt: 2, mb: 1, textAlign: "center", fontFamily: "Times new roman" }}>
                    BARANGAY KAGAWAD
                  </Typography>
                  ...
                  {officials
                    ...
                    .map(o => (
                      <Typography key={o.id} sx={{
                        fontSize: '16px', mb: 1, textTransform: "uppercase", fontWeight: "bold", color: "navy", fontFamily: "Times new roman", textAlign: "center",
                      }}>
                        {o.full_name}
                      </Typography>
                    ))}
                  ...
                  {officials
                    ...
                    .map(o => (
                      <Typography key={o.id} sx={{ mt: 4, textDecoration: "underline", fontSize: '16px', fontWeight: "bold", color: "navy", fontFamily: "Times new roman", textAlign: "center", }}>
                        {o.full_name}
                      </Typography>
                    ))}
                ...
                <Box sx={{ width: "72%", pr: 2, mr: 4, }}>
                  ...
                  >
                    {certType === "business_permit" ? (
                      <>
                        ...
                        <p style={{ textAlign: "center", margin: "6px 0" }}>located at</p>
                        ...
                        >
                          This certifies that the applicant pledges to abide with laws, rules
                          and regulations regarding the said activity and the same is not
                          puissance to public order and safety.
                        </p>
                      ...
                      <Box
                        ...
                        >
                          <p style={{ textAlign: "justify", textIndent: "45px" }}>
                            This is to certify that <b>{buildFullName(selectedResident)?.toUpperCase()}</b>,
                          ...
                          <p style={{ textAlign: "justify", textIndent: "45px" }}>
                            I further certify that the holder/bearer was informed of his/her rights,
                            including the duties and responsibilities accorded by RA 11261 through
                            the <div style={{ fontWeight: "bold", fontFamily: "Times new roman" }}>Oath of Undertaking</div> he/she has signed and executed in the presence of
                            our Barangay Officials.
                          </p>

                          <p style={{ textAlign: "justify", textIndent: "45px" }}>
                            Signed this   <span style={{ textDecoration: "underline", fontWeight: "bold" }}>
                              {" "}
                              {(() => {
                                const d = new Date(issueDate);
                                const day = d.getDate();
                      ...
                      <>
                        <p style={{ marginBottom: "16px", fontSize: "20px" }}>To Whom It May Concern:</p>
                        ...
                        >
                          ...
                          name to avail the scholarship grant for Senior High School at
                          <span style={{ fontWeight: "bold", textDecoration: "underline" }}>
                            {" "}{purpose || ""}
                          </span>.
                        </p>
                  ...
                  <Box
                    sx={{
                      ...
                      width: "100%",
                      mt: 6,
                      px: 2, // add left & right spacing
                    }}
                  >
                    {/* --- Prepared By (Left Side) --- */}
                    {/* --- Prepared By (Left Side) --- */}
                    <Box sx={{ textAlign: "center", marginLeft: 1, }}>
                      <Typography sx={{ textAlign: "left", marginTop: "180px", mb: 2, fontFamily: "Times new roman", fontSize: "20px" }}>
                        Prepared by:
                      </Typography>
                      ...
                      {secretarySignatureUrl && (
                        <img
                          ...
                          style={{ width: 250, height: 100, objectFit: "contain", marginBottom: "-50px", marginTop: "-50px" }}
                        />
                      )}

                      <div>________________________________</div>

                      <Typography sx={{ fontFamily: "Times New Roman", fontWeight: "bold", fontSize: "20px" }}>
                        {secretaryName}
                      </Typography>
                      <Typography sx={{ fontFamily: "Times new roman", fontSize: "20px" }}>
                        Barangay Secretary
                      </Typography>
                    </Box>
                    ...
                    <Box sx={{ textAlign: "center", marginLeft: -4, }}>
                      <Typography sx={{ textAlign: "left", marginTop: "50px", mb: 2, fontFamily: "Times new roman", fontSize: "20px" }}>
                        Certified by:
                      </Typography>
                      ...
                      <div sx={{ maginRight: "50px" }}>________________________________</div>
      ...
      {isBarangayCertificate && (
        <>
              ...
              <Box sx={{ position: "relative", zIndex: 10, display: "flex" }}>
                ...
                <Box sx={{ width: "72%", pr: 2, mr: 4, }}>
                  ...
                  >
                    ...
                    >
                      <p style={{ textAlign: "justify", textIndent: "45px" }}>
                        This is to certify that <span style={{ fontWeight: "bold", textDecoration: "underline" }}>
                          {" "}{buildFullName(selectedResident)?.toUpperCase()}
                        </span>,
                        a resident of  <span style={{ textDecoration: "underline", fontWeight: "bold" }}>
                          {" "}{selectedResident?.address}
                      ...
                      <p style={{ textAlign: "justify", textIndent: "45px" }}>
                        I further certify that the holder/bearer was informed of his/her rights,
                        including the duties and responsibilities accorded by RA 11261 through
                        the <b>Oath of Undertaking</b> he/she has signed and executed in the presence of
                        our Barangay Officials.
                      </p>
          ...
          >
            ...
            {/* ================= TEXT HEADER ================= */}
            <Typography align="center" sx={{ fontSize: "32px", fontFamily: "Bernard MT", fontWeight: "bold", mt: -2 }}>
              Republika ng Pilipinas
            </Typography>
            ...
            <Box sx={{ position: "relative", p: 2 }}>
              ...
              <Box sx={{ position: "relative", zIndex: 1, px: 6 }}>
                ...
                >
                  ...
                  <Box component="ol" sx={{ pl: 4, mt: 2 }}>
                    {oathStatements.map((text, index) => (
                      <li key={index}>
                        <Typography sx={{ fontFamily: "times new roman", fontSize: "20px", ml: 2 }}>{text}</Typography>
                      </li>
                    ))}
                  </Box>

                  <Typography sx={{ mt: 4, fontFamily: "times new roman", fontSize: "20px" }}>
                    Signed this<span style={{ textDecoration: "underline", fontWeight: "bold" }}>
                      {" "}
                      {(() => {
                        const d = new Date(issueDate);
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", mt: 5 }}>
                  <Box>
                    <Typography sx={{ textAlign: "left", marginTop: "120px", mb: 2, fontFamily: "Times new roman", fontSize: "20px" }}>
                      Witnessed by:
                    </Typography>
                  ...
                  <Box>
                    <Typography sx={{ textAlign: "left", marginTop: "-10px", mb: 2, fontFamily: "Times new roman", fontSize: "20px" }}>
                      Certified by:
                    </Typography>
      ...
      <div className={`print-only ${printMode === "certificate_form" ? "active-print" : ""}`}>
        <Box
          sx={{
            width: "100%",
            position: "relative",
            ...
            {Array.from({ length: 4 }).map((_, index) => (
              ...
              >
                ...
                {[
                  ...
                  <Box key={label} sx={{ display: "flex", alignItems: "center", mt: .5 }}>
                    <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "14px", }}>{label}:</Typography>
                ...
                <Box sx={{ display: "flex", }}>
                  <Box sx={{ display: "flex", alignItems: "center", width: "100px" }}>
                    <Typography sx={{ width: "50px", fontWeight: "bold", fontSize: "14px", }}>AGE:</Typography>
                    <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                  </Box>

                  <Box sx={{ display: "flex", alignItems: "center", flexGrow: 1, ml: 1 }}>
                    <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "14px", }}>CIVIL STATUS:</Typography>
                    <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                  </Box>
                </Box>
                ...
                >
                  {/* Question */}
                  <Typography sx={{ fontWeight: "bold", fontSize: "14px", mr: 3 }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", mt: 1 }}>
                  <Typography sx={{ width: "75px", fontWeight: "bold", fontSize: "14px", }}>PURPOSE:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                {/* CONTACT NO */}
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "110px", fontWeight: "bold", fontSize: "14px", }}>CONTACT NO.:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                <Box sx={{ display: "flex", mt: 1, alignItems: "center" }}>
                  <Typography sx={{ width: "60px", fontWeight: "bold", fontSize: "14px", }}>
                    DATE:
                  </Typography>
      ...
      <div className={`print-only ${printMode === "jobseeker" ? "active-print" : ""}`}>
          ...
          >
            {Array.from({ length: 4 }).map((_, index) => (
              ...
              >
                ...
                {/* REQUEST FORM FOR */}
                <Typography sx={{ fontWeight: "bold", fontSize: "14px", mb: 1, textAlign: "center" }}>
                ...
                {/* --- FIELD LINES (NO HELPER FUNCTION!) --- */}
                <Box sx={{ display: "flex", alignItems: "center", }}>
                  <Typography sx={{ width: "100px", fontWeight: "bold", fontSize: "12.5px", }}>FIRST NAME:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "12.5px", }}>MIDDLE NAME:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>
                ...
                <Box sx={{ display: "flex", alignItems: "center", }}>
                  <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "12.5px", }}>LAST NAME:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>


                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "600px", fontWeight: "bold", fontSize: "12.5px", mt: .5 }}>HOW LONG HAVE YOU BEEN IN YOUR PRESENT:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "15px" }} />
                </Box>
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "75px", fontWeight: "bold", fontSize: "12.5px", }}>ADDRESS:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "12.5px" }}>DATE OF BIRTH:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                <Box sx={{ display: "flex", }}>
                  <Box sx={{ display: "flex", alignItems: "center", width: "100px" }}>
                    <Typography sx={{ width: "50px", fontWeight: "bold", fontSize: "12.5px", }}>AGE:</Typography>
                    <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                  </Box>

                  <Box sx={{ display: "flex", alignItems: "center", flexGrow: 1, ml: 1 }}>
                    <Typography sx={{ width: "120px", fontWeight: "bold", fontSize: "12.5px", }}>CIVIL STATUS:</Typography>
                    <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                  </Box>
                </Box>

                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "600px", fontWeight: "bold", fontSize: "12.5px", }}>EDUCATIONAL LEVEL: (ELEM./HS/VOC./COLLEGE/OOSY):</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>
                ...
                >
                  {/* Question */}
                  <Typography sx={{ fontWeight: "bold", fontSize: "12.5px", mr: 3 }}>
                    Are you a Registered Voter?
                  </Typography>
                ...
                {/* CONTACT NO */}
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "110px", fontWeight: "bold", fontSize: "12.5px", }}>CONTACT NO.:</Typography>
                  <Box sx={{ borderBottom: "1px solid black", flexGrow: 1, height: "20px" }} />
                </Box>

                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ width: "60px", fontWeight: "bold", fontSize: "12.5px", }}>
                    DATE:
                  </Typography>
